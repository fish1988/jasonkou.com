...
_log4js.loadAppender('file');
_log4js.addAppender(_log4js.appenders.file(infoLogPath), _config.appName)
_log4js.addAppender(_log4js.appenders.file(errLogPath), _config.appName + '-err')
